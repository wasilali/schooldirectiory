...
export const updatePassword = (pass)=>async(dispatch)=>{
    ...
    try {
        ...
        //kue ka img use honi ic leya multipart use hoa ha
            const config= { Headers:{"Content-type":"application/json"} };
        const { data }=await axios.put(`/api/v1/password/update`,pass,config)
        dispatch({
...
export const resetPassword = (token,pass)=>async(dispatch)=>{
    ...
    try {
        ...
        //kue ka img use honi ic leya multipart use hoa ha
            const config= { Headers:{"Content-type":"application/json"} };
        const { data }=await axios.put(`/api/v1/password/reset/${token}`,pass,config)
        dispatch({
...
export const updateUser = (id,newData)=>async(dispatch)=>{
    ...
    try {
        ...
        //kue ka img use honi ic leya multipart use hoa ha
            const config= { Headers:{"Content-type":"application/json"} };
        const { data }=await axios.put(`/api/v1/admin/user/${id}`,newData,config)
        dispatch({
            type:UPDATE_PASSWORD_SUCCESS,
            payload:data.success,
        })
